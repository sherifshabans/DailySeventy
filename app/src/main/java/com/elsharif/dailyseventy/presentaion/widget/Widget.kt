...
import com.elsharif.dailyseventy.presentaion.components.ShareTextIcon
            ...
            Column(
                ...
                Box(
                    modifier = GlanceModifier
                        ...
                        .background(Color((0xFF294878))), // Set a fixed size for alignment
                    ...
                    SquareIconButton(
                        ...
                        imageProvider =ImageProvider(R.drawable.rounded_inbox_text_share_24) // drawable resource only
                    )
